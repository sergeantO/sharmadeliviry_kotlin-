...
generate_file "${TMPL_PATH}/application/query/GetListQuery.tmpl"            "${PROJECT_PATH}/application/${ENTITY_LOWERCASE}/query/Get${ENTITY}ListQuery.kt"
...
generate_file "${TMPL_PATH}/infrastructure/persistence/Storage.tmpl"        "${PROJECT_PATH}/infrastructure/persistence/${ENTITY_LOWERCASE}/${ENTITY}Storage.kt"
